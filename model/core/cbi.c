...
{
    itf_construct(&cbi->cfg_bti_req_itf, cbi->cycle, "cfg_bti_req_itf", &bti_req_if_to_str, sizeof(bti_req_if_t), 1);
    itf_construct(&cbi->cfg_bti_rsp_itf, cbi->cycle, "cfg_bti_rsp_itf", &bti_rsp_if_to_str, sizeof(bti_rsp_if_t), 1);
    itf_construct(&cbi->cfg_apb_req_itf, cbi->cycle, "cfg_apb_req_itf", &apb_req_if_to_str, sizeof(apb_req_if_t), 1);
    itf_construct(&cbi->cfg_apb_rsp_itf, cbi->cycle, "cfg_apb_rsp_itf", &apb_rsp_if_to_str, sizeof(apb_rsp_if_t), 1);
    ...
    bti_demux_construct(&cbi->i_bti_demux, 3, i_bti_gst_bases, i_bti_gst_sizes);
    ...
    bti_demux_construct(&cbi->d_bti_demux, 4, d_bti_gst_bases, d_bti_gst_sizes);
    ...
    bti2apb_construct(&cbi->cfg_bti2apb);
    ...
    apb_demux_construct(&cbi->cfg_apb_demux, 3, cfg_apb_gst_bases, cfg_apb_gst_sizes);
}
