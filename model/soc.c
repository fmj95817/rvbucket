...
void soc_construct(soc_t *soc, const u64 *cycle)
{
    ...
    itf_construct(&soc->cpu_bti_req_itf, cycle, "cpu_bti_req_itf", &bti_req_if_to_str, sizeof(bti_req_if_t), 1);
    itf_construct(&soc->cpu_bti_rsp_itf, cycle, "cpu_bti_rsp_itf", &bti_rsp_if_to_str, sizeof(bti_rsp_if_t), 1);
    ...
    itf_construct(&soc->tcm_bti_req_itf, cycle, "tcm_bti_req_itf", &bti_req_if_to_str, sizeof(bti_req_if_t), 1);
    itf_construct(&soc->tcm_bti_rsp_itf, cycle, "tcm_bti_rsp_itf", &bti_rsp_if_to_str, sizeof(bti_rsp_if_t), 1);
