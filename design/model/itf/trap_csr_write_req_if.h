...
#define TRAP_CSR_WRITE_REQ_SIGNAL_IF_CONSTRUCT(module, itf, dis_trace, ext_src) \
    TRAP_CSR_WRITE_REQ_SIGNAL_IF_CONSTRUCT_INNER(module, itf, dis_trace, ext_src, false)

#define TRAP_CSR_WRITE_REQ_SIM_PROT_SIGNAL_IF_CONSTRUCT(module, itf, dis_trace, sim_prot) \
    TRAP_CSR_WRITE_REQ_SIGNAL_IF_CONSTRUCT_INNER(module, itf, dis_trace, false, sim_prot)

#define TRAP_CSR_WRITE_REQ_SIGNAL_IF_CONSTRUCT_INNER(module, itf, dis_trace, ext_src, sim_prot_) do { \
    itf_conf_t conf = { \
...
#define TRAP_CSR_WRITE_REQ_IF_CONSTRUCT(module, itf, depth) \
    TRAP_CSR_WRITE_REQ_IF_CONSTRUCT_INNER(module, itf, depth, false)

#define TRAP_CSR_WRITE_REQ_SIM_PROT_IF_CONSTRUCT(module, itf, depth, sim_prot) \
    TRAP_CSR_WRITE_REQ_IF_CONSTRUCT_INNER(module, itf, depth, sim_prot)

#define TRAP_CSR_WRITE_REQ_IF_CONSTRUCT_INNER(module, itf, depth, sim_prot_) do { \
    itf_conf_t conf = { \
        .cycle = module->mod.cycle, \
        .hier_name = module->mod.hier_name, \
        .mode = ITF_MODE_FIFO, \
