...
#define AXI4_AR_SIGNAL_IF_CONSTRUCT(module, itf, dis_trace, ext_src) \
    AXI4_AR_SIGNAL_IF_CONSTRUCT_INNER(module, itf, dis_trace, ext_src, false)

#define AXI4_AR_SIM_PROT_SIGNAL_IF_CONSTRUCT(module, itf, dis_trace, sim_prot) \
    AXI4_AR_SIGNAL_IF_CONSTRUCT_INNER(module, itf, dis_trace, false, sim_prot)

#define AXI4_AR_SIGNAL_IF_CONSTRUCT_INNER(module, itf, dis_trace, ext_src, sim_prot_) do { \
    itf_conf_t conf = { \
...
#define AXI4_AR_IF_CONSTRUCT(module, itf, depth) \
    AXI4_AR_IF_CONSTRUCT_INNER(module, itf, depth, false)

#define AXI4_AR_SIM_PROT_IF_CONSTRUCT(module, itf, depth, sim_prot) \
    AXI4_AR_IF_CONSTRUCT_INNER(module, itf, depth, sim_prot)

#define AXI4_AR_IF_CONSTRUCT_INNER(module, itf, depth, sim_prot_) do { \
    itf_conf_t conf = { \
        .cycle = module->mod.cycle, \
        .hier_name = module->mod.hier_name, \
        .mode = ITF_MODE_FIFO, \
