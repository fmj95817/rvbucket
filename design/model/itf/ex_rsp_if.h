...
#define EX_RSP_SIGNAL_IF_CONSTRUCT(module, itf, dis_trace, ext_src) \
    EX_RSP_SIGNAL_IF_CONSTRUCT_INNER(module, itf, dis_trace, ext_src, false)

#define EX_RSP_SIM_PROT_SIGNAL_IF_CONSTRUCT(module, itf, dis_trace, sim_prot) \
    EX_RSP_SIGNAL_IF_CONSTRUCT_INNER(module, itf, dis_trace, false, sim_prot)

#define EX_RSP_SIGNAL_IF_CONSTRUCT_INNER(module, itf, dis_trace, ext_src, sim_prot_) do { \
    itf_conf_t conf = { \
...
#define EX_RSP_IF_CONSTRUCT(module, itf, depth) \
    EX_RSP_IF_CONSTRUCT_INNER(module, itf, depth, false)

#define EX_RSP_SIM_PROT_IF_CONSTRUCT(module, itf, depth, sim_prot) \
    EX_RSP_IF_CONSTRUCT_INNER(module, itf, depth, sim_prot)

#define EX_RSP_IF_CONSTRUCT_INNER(module, itf, depth, sim_prot_) do { \
    itf_conf_t conf = { \
        .cycle = module->mod.cycle, \
        .hier_name = module->mod.hier_name, \
        .mode = ITF_MODE_FIFO, \
